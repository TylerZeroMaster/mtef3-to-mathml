...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    2 => "embDOT", # over single dot
    3 => "embDDOT", # over double dot
    4 => "embTDOT", # over triple dot
    24 => "emb4DOT", # over quad dot
    -->
    <!-- Dots -->

    <xsl:template match="embell[embell='embDOT']">
        <mover accent="true">
    ...
    <xsl:template match="embell[embell='embDDOT']">
        <mover accent="true">
            <xsl:apply-templates select="(char | mn | mo | mtext | mi)[1]"/>
            <mo>&#xA8;</mo>
        </mover>
    ...
    <xsl:template match="embell[embell='embTDOT']">
        <mover accent="true">
            <xsl:apply-templates select="(char | mn | mo | mtext | mi)[1]"/>
            <mo>&#x20DB;</mo>
        </mover>
    ...
    <xsl:template match="embell[embell='embPRIME']">
        <msup>
            <xsl:apply-templates select="(char | mn | mo | mtext | mi)[1]"/>
            <mo>&#x2032;</mo>
        </msup>
    ...
    <xsl:template match="embell[embell='embDPRIME']">
        <msup>
            <xsl:apply-templates select="(char | mn | mo | mtext | mi)[1]"/>
            <mo>&#x2033;</mo>
        </msup>
    ...
    <xsl:template match="embell[embell='embTPRIME']">
        <msup>
            <xsl:apply-templates select="(char | mn | mo | mtext | mi)[1]"/>
            <mo>&#x2034;</mo>
        </msup>
