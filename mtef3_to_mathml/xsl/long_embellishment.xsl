...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tmpl[selector='tmOBAR' and variation='tvDOBAR']">
        <mover accent="true">
            <mover accent="true">
                <xsl:apply-templates select="(slot | pile)[1]"/>
                <mo stretchy="true">&#xAF;</mo>
    ...
    <xsl:template match="tmpl[selector='tmUBAR' and variation='tvDUBAR']">
        <munder accentunder="true">
            <munder accentunder="true">
                <xsl:apply-templates select="(slot | pile)[1]"/>
                <mo stretchy="true">_</mo>
    ...
    <xsl:template match="tmpl[selector='tmOARC']">
        <mover accent="true">
            <xsl:apply-templates select="(slot | pile)[1]"/>
            <mo stretchy="true">&#x2322;</mo>
        </mover>
